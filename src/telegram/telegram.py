...
from src.database.db_queries import check_token_role, create_user, create_lab, get_all_labs, is_admin, is_stud, is_exist_user, get_all_users
...
@dp.message(F.text, Gen.wait_full_name)
async def check_token(message: types.Message, state: FSMContext):
